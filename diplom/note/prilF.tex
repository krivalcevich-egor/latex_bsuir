...
\addcontentsline{toc}{section}{\hspace*{-1em}Приложение Е (Обязательное) Схема электрическая функциональная}\par

\normalsize
\begin{center}
  \textbf{ПРИЛОЖЕНИЕ Е} \\
  \textbf{(Обязательное)} \\
  \textbf{Схема электрическая функциональная}
\end{center}
...
% Вставка листа A3
\includepdf[pages=-, pagecommand={}, fitpaper, offset=0 0]{FUNCTIONAL.pdf}
