...
\include{appendix/prilF}      % Приложение Е 
\include{appendix/prilG}      % Приложение Ж 
\include{appendix/prilH}      % Приложение З 
\include{appendix/prilI}      % Приложение И 
\include{appendix/prilJ}      % Приложение К      
\include{appendix/prilK}      % Приложение Л      
\include{appendix/prilL}      % Приложение М      
