...
% ПРИЛОЖЕНИЯ
% -----------------------------------------------------------------------------
\include{prilA}               % Приложение А 
\include{prilB}               % Приложение Б
\include{prilC}               % Приложение В 
\include{prilD}               % Приложение Г 
\include{prilE}               % Приложение Д 
\include{prilF}               % Приложение Е 
\include{prilG}               % Приложение Ж 
\include{prilH}               % Приложение З 
\include{prilI}               % Приложение И      
