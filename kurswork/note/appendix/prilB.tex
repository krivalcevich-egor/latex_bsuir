...
\addcontentsline{toc}{section}{\hspace*{-1em}Приложение Б (Обязательное) Пример вставки pdf размером А3 с перечнем}\par

\normalsize
\begin{center}
  \textbf{ПРИЛОЖЕНИЕ Б} \\
  \textbf{(Обязательное)} \\
  \textbf{Пример вставки pdf размером А3 с перечнем}
\end{center}
